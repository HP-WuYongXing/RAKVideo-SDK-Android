...
public class DeviceSettings extends Activity{
   ...
   void Modify_Password(int port){
       _parametersConfig = new ParametersConfig(_deviceIp+":"+port, _videoSettingsPsk.getText().toString());
       _parametersConfig.setOnResultListener(new ParametersConfig.OnResultListener()
        {
            ...
            {
                if (result.type==ParametersConfig.UPDATE_USERNAME_PASSWORD) {
       ...
       _parametersConfig.updateUsernameAndPassword("admin",_videoSettingsConfirmPsk.getText().toString());
    }
        ...
        _parametersConfig.setOnResultListener(new ParametersConfig.OnResultListener() {
            ...
            public void onResult(ParametersConfig.Response result) {
                if (result.type == ParametersConfig.GET_FPS) {
                    ...
                    _parametersConfig.getQuality(0);
                }

                if (result.type == ParametersConfig.GET_QUALITY) {
                    if (result.statusCode == 200) {
                        String ff=result.body.replace(" ","");
                        String keyStr="\"value\":\"";
                        int index=ff.indexOf(keyStr);
                    ...
                    _parametersConfig.getGOP();
                }

                if (result.type == ParametersConfig.GET_GOP) {
                    if (result.statusCode == 200) {
                        String ff=result.body.replace(" ","");
                        String keyStr="\"value\":\"";
                        int index=ff.indexOf(keyStr);
    ...
    private void setParameter() {
        ...
        _parametersConfig.setOnResultListener(new ParametersConfig.OnResultListener() {
            @Override
            public void onResult(ParametersConfig.Response result) {
                if (result.type == ParametersConfig.SET_FPS) {
                    if (result.statusCode == 200) {
                        _parametersConfig.setQuality(0,Integer.parseInt(_videoSettingsQuality.getText().toString()));
                    }
                    else{
                        Toast.show(DeviceSettings.this,getString(R.string.set_video_fps_failed));
                    }
                }
                if (result.type == ParametersConfig.SET_QUALITY) {
                    if (result.statusCode == 200) {
                        _parametersConfig.setGOP(Integer.parseInt(_videoSettingsGop.getText().toString()));
                    }
                    else{
                        Toast.show(DeviceSettings.this,getString(R.string.set_video_quality_failed));
                    }
                }
                else if (result.type == ParametersConfig.SET_GOP) {
                    if (result.statusCode == 200) {
        ...
        _parametersConfig.setFps(0,Integer.parseInt(_videoSettingsFps.getText().toString()));
    }
