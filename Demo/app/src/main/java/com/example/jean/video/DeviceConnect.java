...
public class DeviceConnect extends Activity{
    ...
    private ParametersConfig _parametersConfig =null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _parametersConfig = new ParametersConfig(_deviceIp + ":" + 80, _deviceConnectPsk.getText().toString());
    ...
    void StartParametersConfigListener(){
        _parametersConfig.setOnResultListener(new ParametersConfig.OnResultListener() {
            ...
            public void onResult(ParametersConfig.Response result) {
                if (result.type == ParametersConfig.GET_USERNAME_PASSWORD) {
                    if (result.statusCode == 200) {
                        ...
                        if (password.equals(_deviceConnectPsk.getText().toString())) {
                            ...
                            _parametersConfig.SetModuleRtcTime(date, hour, min, sec, tzStr);//Set Sd Time
                        } else {
                ...
                else if (result.type == ParametersConfig.SET_MODULE_RTC_TIME) {
                    if (result.statusCode == 200) {
                    } else {
                ...
                else if (result.type == ParametersConfig.GET_VERSION) {
                    if (result.statusCode == 200) {
    ...
    View.OnClickListener _deviceConnectBtn_Click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(_deviceIp.equals("127.0.0.1")){
                ...
                _remoteTunnel.openTunnel(0, 80, 80, _deviceId);
...
//            }
    ...
    private void checkDevicesPassword(int port){
        _parametersConfig.getUsernameAndPassword();
    }
